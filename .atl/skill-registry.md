...
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/12-principles-of-animation/SKILL.md
- Rules:
...
### accessibility
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/accessibility/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### adev-writing-guide
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/adev-writing-guide/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### angular-developer
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/angular-developer/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### animate-text
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/animate-text/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### branch-pr
- Path: /home/user/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/user/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /home/user/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/user/.config/opencode/skills/comment-writer/SKILL.md
...
### deploy-to-vercel
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/deploy-to-vercel/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### frontend-design
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/frontend-design/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: /home/user/.config/opencode/skills/go-testing/SKILL.md
...
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/high-end-visual-design/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### issue-creation
- Path: /home/user/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/user/.config/opencode/skills/judgment-day/SKILL.md
...
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/nodejs-backend-patterns/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### nodejs-best-practices
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/nodejs-best-practices/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### pr_review
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/pr_review/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### redesign-existing-projects
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/redesign-existing-projects/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### reference-compiler-cli
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/reference-compiler-cli/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### reference-core
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/reference-core/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### reference-signal-forms
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/reference-signal-forms/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### seo
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/seo/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: /home/user/.config/opencode/skills/skill-creator/SKILL.md
...
### transitions-dev
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/transitions-dev/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### typescript-advanced-types
- Path: /mnt/c/Users/juan.peralta/Documents/Projects/Finance-Tracker-Frontend/.agents/skills/typescript-advanced-types/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: /home/user/.config/opencode/skills/work-unit-commits/SKILL.md
