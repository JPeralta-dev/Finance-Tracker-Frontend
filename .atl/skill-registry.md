...
<!-- Auto-generated by gentle-ai sdd-init refresh. -->

Last updated: 2026-06-25

## Sources scanned

- .agents/skills (18 project skills)
- /root/.config/opencode/skills (22 system skills)
...
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/12-principles-of-animation/SKILL.md
- Trigger: Audit animation code against Disney's 12 principles adapted for web.
- Rules:
...
### accessibility
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/accessibility/SKILL.md
- Trigger: Audit and improve web accessibility following WCAG 2.2 guidelines.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### adev-writing-guide
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/adev-writing-guide/SKILL.md
- Trigger: Comprehensive writing guide for Angular documentation (adev).
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### angular-developer
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/angular-developer/SKILL.md
- Trigger: Generates Angular code and provides architectural guidance.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### animate-text
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/animate-text/SKILL.md
- Trigger: Curated text animation catalog with exact JSON specs.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### branch-pr
- Path: /root/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /root/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /root/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /root/.config/opencode/skills/comment-writer/SKILL.md
...
### deploy-to-vercel
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/deploy-to-vercel/SKILL.md
- Trigger: Deploy applications and websites to Vercel.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### frontend-design
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/frontend-design/SKILL.md
- Trigger: Create distinctive, production-grade frontend interfaces with high design quality.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: /root/.config/opencode/skills/go-testing/SKILL.md
...
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/high-end-visual-design/SKILL.md
- Trigger: Teaches the AI to design like a high-end agency.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### issue-creation
- Path: /root/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /root/.config/opencode/skills/judgment-day/SKILL.md
...
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/nodejs-backend-patterns/SKILL.md
- Trigger: Build production-ready Node.js backend services with Express/Fastify.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### nodejs-best-practices
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/nodejs-best-practices/SKILL.md
- Trigger: Node.js development principles and decision-making.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### pr_review
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/pr_review/SKILL.md
- Trigger: Guidelines and tools for reviewing pull requests in the Angular repository.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### redesign-existing-projects
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/redesign-existing-projects/SKILL.md
- Trigger: Upgrades existing websites and apps to premium quality.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### reference-compiler-cli
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/reference-compiler-cli/SKILL.md
- Trigger: Explains the mental model and architecture of the code under `packages/compiler-cli`.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### reference-core
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/reference-core/SKILL.md
- Trigger: Explains the mental model and architecture of the code under `packages/core`.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### reference-signal-forms
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/reference-signal-forms/SKILL.md
- Trigger: Explains the mental model and architecture of the code under `packages/forms/signals`.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### seo
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/seo/SKILL.md
- Trigger: Optimize for search engine visibility and ranking.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: /root/.config/opencode/skills/skill-creator/SKILL.md
...
### skill-improver
- Path: /root/.config/opencode/skills/skill-improver/SKILL.md
- Trigger: improve skills, audit skills, refactor skills, skill quality. Audit and upgrade existing LLM-first skills.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### transitions-dev
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/transitions-dev/SKILL.md
- Trigger: Production-ready CSS transitions for web apps.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### typescript-advanced-types
- Path: /mnt/c/Users/juand/Documents/Prog/financeTracker/Finance-Tracker-Frontend/.agents/skills/typescript-advanced-types/SKILL.md
- Trigger: Master TypeScript's advanced type system including generics, conditional types, mapped types.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: /root/.config/opencode/skills/work-unit-commits/SKILL.md
